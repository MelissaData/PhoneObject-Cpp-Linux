 ...
 *   mdEnums.h declare the API, and libmdPhone.so carries the implementation. The
 *   accompanying MelissaPhoneObjectLinuxCpp.sh script downloads all three on every run.
 *
 * Reference:
